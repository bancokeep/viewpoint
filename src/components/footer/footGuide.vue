    ...
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/msite', query: {geohash}})" class="guide_item">
            <section class="icon_style">
                <img v-show="$route.path.indexOf('msite') !== -1" src="../../images/iconz_a.png">
                <img v-show="$route.path.indexOf('msite') == -1" src="../../images/iconz.png">
                <!-- <img :src="$route.path.indexOf('msite') !== -1? '../../images/iconz_a.png' : '../../images/iconz.png'"> -->
            </section>
