<template>
    <div>
    	<head-top signin-up='msite'>
			...
			<div><span class="title_text ellipsis">影视</span></div>
			<!-- <router-link to="/home" slot="msite-title" class="msite_title">
				<span class="title_text ellipsis">{{msietTitle}}</span>
			</router-link> -->
			<router-link to="/home" slot="msite-title" class="msite_title">
				<span class="title_text ellipsis">观点影视</span>
			</router-link>
    	</head-top>
		<nav class="nav-box">
    	...
    	<div class="shop_list_container">
	    	<video-list v-if="hasGetData" :geohash="geohash"></video-list>
    	</div>
...
import videoList from 'src/components/common/videolist'
